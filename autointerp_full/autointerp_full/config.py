...
class RunConfig(Serializable):
    ...
    explainer: str = field(
        choices=["default", "np_max_act", "none"],
        default="default",
    )
    """Explainer to use for generating explanations. Options are 'default' for
    the default single token explainer, 'np_max_act' for Neuronpedia-style max-activation
    explainer, and 'none' for no explanation generation."""
