...
Uses the JSONL output from compute_examples_finance.py to generate human-readable labels.
"""
...
def generate_labels_from_examples_file(
...
if __name__ == "__main__":
    fire.Fire(generate_labels_from_examples_file)
