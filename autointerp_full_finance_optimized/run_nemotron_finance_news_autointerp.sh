...
echo "🚀 AutoInterp Financial News Analysis - Nemotron Top 2 Features (Granular Prompts)"
echo "=================================================================================="
echo "🔍 Analyzing top 2 features from Nemotron SAE with granular prompts"
echo "⚡ Using vLLM server for faster inference"
echo "📊 Processing top 2 features (Layer 28, K=64)"
