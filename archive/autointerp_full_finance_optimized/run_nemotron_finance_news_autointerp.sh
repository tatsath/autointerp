...
echo "🚀 AutoInterp Financial News Analysis - Nemotron Top 100 Features (Granular Prompts)"
echo "====================================================================================="
echo "🔍 Analyzing top 100 features from Nemotron SAE with granular prompts"
echo "⚡ Using vLLM server for faster inference"
echo "📊 Processing top 100 features (Layer 28, K=64)"
...
N_TOKENS=20000000  # 20M tokens for analysis (increased for better quality)
LAYER=28
DICT_SIZE=35840
...
echo "📈 Using 20M tokens for analysis (cache will be regenerated)"
...
# Delete old explanations and cache to force regeneration with 20M tokens
...
# # Delete old cache to force regeneration with 20M tokens
# if [ -d "results/$RUN_NAME/latents" ]; then
#     echo "🗑️  Removing old cache to force regeneration with 20M tokens..."
#     rm -rf "results/$RUN_NAME/latents"
#     echo "✅ Old cache removed"
# fi

# Run AutoInterp for Nemotron features with financial-news dataset
