#!/usr/bin/env python3
"""
Generate enhanced CSV summary for Nemotron AutoInterp results
...
def generate_enhanced_csv(results_dir):
    ...
    # Write CSV file
    if csv_data:
        csv_file = results_path / "nemotron_reasoning_results_summary_enhanced.csv"
        fieldnames = [
            'layer', 'feature', 'label',
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python generate_nemotron_enhanced_csv.py <results_dir>")
        print("Example: python generate_nemotron_enhanced_csv.py results/nemotron_reasoning_run")
        sys.exit(1)
    
    results_dir = sys.argv[1]
    generate_enhanced_csv(results_dir)
