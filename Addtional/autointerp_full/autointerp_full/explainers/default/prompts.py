...
- Focus on the MOST COMMON pattern that appears in AT LEAST 40-60% of the top examples
- The explanation must represent a SIGNIFICANT PORTION of examples (at least 4-6 examples), not just 1-2 rare cases
- Higher-activation examples are MORE IMPORTANT - your explanation should match patterns from the top 40-60% of examples
...
- If a pattern only appears in 1-2 examples (less than 20% of examples), it's TOO SPECIFIC - find a broader pattern that covers MORE examples
...
1. Look at ACTIVATING examples (ordered by activation strength, highest first)
2. Count how many examples share a common pattern - aim for 40-60% of examples (at least 4-6 examples)
3. Higher-activation examples (shown first with higher max_activation values) are MORE REPRESENTATIVE - prioritize patterns from these
4. Compare with NON-ACTIVATING examples - what makes activating examples UNIQUE?
5. Identify the ONE most common concept, entity, pattern, or structure across MULTIPLE examples (40-60% coverage)
6. Use the MOST PRECISE terminology possible while still covering MORE examples (not just rare cases)
7. If you see a pattern in only 1-2 examples (less than 20% of examples), it's TOO SPECIFIC - find a broader pattern
8. Count your words - must be 5-7 words exactly
9. VALIDATE: Your explanation should match at least 40-60% of examples (4-6+ examples), not just 1-2 (less than 20%)
...
- The explanation must represent AT LEAST 40-60% of examples (4-6+ examples) - if it only matches 1-2 examples (less than 20%), it's too specific
- Higher-activation examples (shown first with higher max_activation values) are more important - patterns from these should be prioritized
- Focus on patterns that appear in the TOP 40-60% of examples by activation strength

You will be given text examples with ACTIVATING and NON-ACTIVATING examples clearly labeled. Examples are ordered by activation strength (highest first, with max_activation values shown). Identify the SINGLE MOST COMMON pattern that appears in AT LEAST 40-60% of the examples (4-6+ examples) in 5-7 words.
