...
def generate_enhanced_csv(results_dir):
    ...
    # Write CSV file
    if csv_data:
        csv_file = results_path / "nemotron_finance_results_summary_enhanced.csv"
        fieldnames = [
            'layer', 'feature', 'label',
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        print("Example: python generate_nemotron_enhanced_csv.py results/nemotron_finance_run")
        sys.exit(1)
