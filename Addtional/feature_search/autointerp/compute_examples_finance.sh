...
FEATURE_LIST_PATH="${FEATURE_LIST_PATH:-../domain_finance/results/finance_top_features_scores.json}"
OUTPUT_PATH="${OUTPUT_PATH:-result/finance_feature_examples.jsonl}"
